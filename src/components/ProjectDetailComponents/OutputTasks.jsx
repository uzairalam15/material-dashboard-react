...
import FailureModeElement from "./FailureModeElement.jsx";
...
class OutputTasks extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  delete = e => {
    e.stopPropagation();
    this.props.deleteOutput(this.props.item.id);
  };

  toggleOutputModal = e => {
    e.stopPropagation();
    this.props.toggleOutputModal(null, "update", this.props.item);
  };
...
export default withStyles(styles)(OutputTasks);
