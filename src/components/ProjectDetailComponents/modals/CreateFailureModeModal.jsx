...
class CreateFailureModeModal extends React.PureComponent {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.open && nextProps.modalMode !== "create") {
      this.populateData(nextProps.selectedFailureMode);
  ...
  onSubmit = () => {
    ...
    if (this.props.modalMode !== "create") {
      this.props.onSubmit(submitState, this.props.selectedFailureMode.id);
    } else {
      submitState.OutputRID = this.props.selectedOutput.id;
