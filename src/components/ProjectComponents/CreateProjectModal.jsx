...
export default class CreateProjectModal extends React.PureComponent {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.open && nextProps.modalMode !== "create") {
      this.populateData(nextProps.selectedProject);
  ...
  onSubmit = () => {
    ...
    if (this.props.modalMode !== "create") {
      this.props.onSubmit(submitState, this.props.selectedProject.id);
    } else {
      submitState.ProgramRID = this.props.selectedProgram;
