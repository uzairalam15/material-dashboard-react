...
const headerRoutes = [
  ...
  { name: "Project Analysis", current: true, path: "#" }
];

class ProjectAnalysisContainer extends React.Component {
  constructor(props) {
    super(props);
  }
...
ProjectAnalysisContainer.propTypes = {
...
)(withRouter(withStyles(programStyle)(ProjectAnalysisContainer)));
